...
Version `1.6.0`, **25 checks**, **55 fixtures**. Every count in this document is mechanically
...
bin/gb-surface-gate.py --selftest                 # 55 fixtures, must be 55/55
...
- Every check ships a known-bad fixture proven to make it RED/ERROR. 55 fixtures: 5 known-good
  (a clean week; a reviewed capability delta; an acknowledged pause; a reviewed self-made routine;
  a new Bot inside the fleet grace window) keep the suite from drifting over-strict, 38 known-bad
  RED and 12 known-bad ERROR keep it honest.
- Mutation-verified 25 of 25 (closed 2026-09-12). `--selftest --disable <check>` must FAIL for
