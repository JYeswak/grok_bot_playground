...
Do the arithmetic on your own computer with `python3` and show the snippet you ran. A number you
produced in your head is a number nobody can check.
...
## Refusals, and what to say instead
