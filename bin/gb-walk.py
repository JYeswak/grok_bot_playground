...
def render_bots(doc: Dict[str, Any], ink: Ink, *, step: bool, interactive: bool) -> int:
    ...
    emit()
    emit(
        "  This repository MEASURES a Grok Bot deployment and PROPOSES Bots for it. Charters\n"
        "  deploy over the API too (`gb templates deploy <id> --apply`, seed + manifest +\n"
        "  rollback; routines are asked for in chat, never uploaded). Every screen below ends\n"
