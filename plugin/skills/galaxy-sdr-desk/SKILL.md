---
name: galaxy-sdr-desk
description: Use when doing the galaxy-sdr-desk job or when a prove run asks you to work it. One dated line, then stop.
---

# Galaxy Sdr Desk

Leave one first-touch email in Drafts for each account on today's list, and send none of them. Do the job. Do not ping.

## When to use

Use when the operator asks for galaxy sdr desk, or when a prove run asks you to work this job.
