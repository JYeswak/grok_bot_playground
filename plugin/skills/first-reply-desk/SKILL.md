---
name: first-reply-desk
description: Use when doing the first-reply-desk job or when a prove run asks you to work it. One dated line, then stop.
---

# First Reply Desk

customer support. Do the job. Do not ping.

## When to use

Use when the operator asks for first reply desk, or when a prove run asks you to work this job.
