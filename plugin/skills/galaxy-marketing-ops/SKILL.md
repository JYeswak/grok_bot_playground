---
name: galaxy-marketing-ops
description: Use when doing the galaxy-marketing-ops job or when a prove run asks you to work it. One dated line, then stop.
---

# Galaxy Marketing Ops

Post one weekly block naming what the marketing plan promised and what actually shipped. Do the job. Do not ping.

## When to use

Use when the operator asks for galaxy marketing ops, or when a prove run asks you to work this job.
